    ...
    <section className="w-full bg-[#070B16] px-6 py-24 text-white md:px-12">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-16 flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-2 rounded-full border border-blue-400/30 bg-blue-500/10 px-4 py-2">
            <span className="text-sm font-semibold text-blue-300">40 participants</span>
          </div>
          <div className="flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-4 py-2">
            <span className="text-sm text-slate-400">Moderated interviews</span>
          </div>
          <div className="flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-4 py-2">
            <span className="text-sm text-slate-400">Recruited via online communities & personal network</span>
          </div>
          <div className="flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-4 py-2">
            <span className="text-sm text-slate-400">45-min sessions · Remote · Zoom</span>
          </div>
        </div>

        <div className="mb-28">
          <h3 className="mb-4 text-2xl font-semibold">Personas</h3>

          {/* FIX 2 — composite persona disclaimer */}
          <div className="mb-8 flex items-start gap-3 rounded-[20px] border border-white/10 bg-white/[0.04] px-5 py-4">
            <span className="mt-0.5 text-slate-500">ℹ</span>
            <p className="text-sm leading-6 text-slate-400">
              These are composite personas synthesized from 40 participant interviews, not real individuals.
              ...
              >
                <div className="grid gap-8 md:grid-cols-[260px_1fr]">
                  <div>
                    <img
                      src={persona.image}
                      alt={`Representational image for ${persona.name} composite persona`}
                    ...
                    <div className="mt-5 rounded-[24px] border border-white/10 bg-[#0B1120]/80 p-5">
                      <div className="flex items-center justify-between gap-2 flex-wrap">
                        ...
                        <span className="rounded-full border border-blue-400/20 bg-blue-500/10 px-2 py-0.5 text-xs text-blue-400">
